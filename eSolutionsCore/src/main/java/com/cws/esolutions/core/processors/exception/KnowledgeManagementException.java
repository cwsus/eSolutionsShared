 ...
 */
public class KnowledgeManagementException extends CoreServicesException
{
	private static final long serialVersionUID = -2467280568219767656L;
     ...
     */
    public KnowledgeManagementException(final String message)
    {
        super(message);
    }
     ...
     */
    public KnowledgeManagementException(final Throwable throwable)
    {
        super(throwable);
    }
     ...
     * @param throwable - The throwable for the exception
     */
    public KnowledgeManagementException(final String message, final Throwable throwable)
    {
