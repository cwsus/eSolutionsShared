 ...
 */
public class ApplicationEnablementException extends CoreServicesException
{
	private static final long serialVersionUID = 3365778873278074779L;
     ...
     */
    public ApplicationEnablementException(final String message)
    {
        super(message);
    }
     ...
     */
    public ApplicationEnablementException(final Throwable throwable)
    {
        super(throwable);
    }
     ...
     * @param throwable - The throwable for the exception
     */
    public ApplicationEnablementException(final String message, final Throwable throwable)
    {
