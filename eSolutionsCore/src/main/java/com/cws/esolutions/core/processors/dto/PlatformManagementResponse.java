...
public class PlatformManagementResponse implements Serializable
{
    ...
    private static final long serialVersionUID = -4662841805959535610L;
    ...
    {
        final String methodName = PlatformManagementResponse.CNAME + "#setPlatform(final Platform value)";
    ...
    {
        final String methodName = PlatformManagementResponse.CNAME + "#getPlatform()";
