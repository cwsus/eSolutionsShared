 ...
 * Package: com.cws.esolutions.core.processors.exception
 * File: PlatformManagementException.java
 *
 * History
 *
 ...
 */
public class PlatformManagementException extends CoreServicesException
{
     ...
     */
    public PlatformManagementException(final String message)
    {
        super(message);
    }
     ...
     */
    public PlatformManagementException(final Throwable throwable)
    {
        super(throwable);
    }
     ...
     * @param throwable - The throwable for the exception
     */
    public PlatformManagementException(final String message, final Throwable throwable)
    {
