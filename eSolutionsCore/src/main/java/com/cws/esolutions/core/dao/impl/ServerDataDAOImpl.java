...
public class ServerDataDAOImpl implements IServerDataDAO
{
    ...
    public synchronized boolean addServer(final List<Object> serverData) throws SQLException
    {
        ...
        try
        {
            ...
            stmt.setString(5, (String) serverData.get(4)); // IN networkPartition VARCHAR(45),
            stmt.setString(6, (String) serverData.get(5)); // IN datacenter VARCHAR(128),
            stmt.setString(7, (String) serverData.get(6)); // IN systemType VARCHAR(45),
            stmt.setString(8, (String) serverData.get(7)); // IN domainName VARCHAR(255),
            stmt.setString(9, (String) serverData.get(8)); // IN cpuType VARCHAR(255),
            stmt.setInt(10, (Integer) serverData.get(9)); // IN cpuCount INT,
            stmt.setString(11, (String) serverData.get(10)); // IN serverModel VARCHAR(255),
            stmt.setString(12, (String) serverData.get(11)); // IN serialNumber VARCHAR(255),
            stmt.setInt(13, (Integer) serverData.get(12)); // IN installedMemory INT,
            stmt.setString(14, (String) serverData.get(13)); // IN operIp VARCHAR(50),
            stmt.setString(15, (String) serverData.get(14)); // IN operHostname VARCHAR(100),
            stmt.setString(16, (String) serverData.get(15)); // IN mgmtIp VARCHAR(50),
            stmt.setString(17, (String) serverData.get(16)); // IN mgmtHostname VARCHAR(100),
            stmt.setString(18, (String) serverData.get(17)); // IN backupIp VARCHAR(50),
            stmt.setString(19, (String) serverData.get(18)); // IN backupHostname VARCHAR(100),
            stmt.setString(20, (String) serverData.get(19)); // IN nasIp VARCHAR(50),
            stmt.setString(21, (String) serverData.get(20)); // IN nasHostname VARCHAR(100),
            stmt.setString(22, (String) serverData.get(21)); // IN natAddr VARCHAR(50),
            stmt.setString(23, (String) serverData.get(22)); // IN systemComments TEXT,
            stmt.setString(24, (String) serverData.get(23)); // IN engineer VARCHAR(100),
            stmt.setString(25, (String) serverData.get(24)); // IN serverRack VARCHAR(255),
            stmt.setString(26, (String) serverData.get(25)); // IN rackPosition VARCHAR(255),
