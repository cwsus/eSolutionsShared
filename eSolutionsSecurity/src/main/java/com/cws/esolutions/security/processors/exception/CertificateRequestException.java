 ...
 */
public class CertificateRequestException extends SecurityServiceException
{
     ...
     */
    public CertificateRequestException(final Throwable throwable)
    {
        super(throwable);
    }
     ...
     */
    public CertificateRequestException(final String message, final Throwable throwable)
    {
