...
public class AccountSearchException extends SecurityServiceException
{
     ...
     */
    public AccountSearchException(final String message)
    {
        super(message);
    }
     ...
     */
    public AccountSearchException(final Throwable throwable)
    {
        super(throwable);
    }
     ...
     */
    public AccountSearchException(final String message, final Throwable throwable)
    {
